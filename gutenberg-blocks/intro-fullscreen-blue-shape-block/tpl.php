<?php
/**
 * Block template file: gutenberg-blocks/intro-fullscreen-blue-shape-block/tpl.php
 *
...
$id = 'intro-fullscreen-blue-shape-block-' . $block['id'];
if ( !empty( $block['anchor'] ) ) {
	$id = $block['anchor'];
}

// Create class attribute allowing for custom "className" and "align" values.
$classes = 'intro-fullscreen-blue-shape-block';
